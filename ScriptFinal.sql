...
--------------------------------------------------------
  ...
  CREATE TABLE "HSC"."INICIO_MODELO" 
...
Insert into HSC.INICIO_DIRECCION (IDDIRECCION,REGION_ID,USUARIO_ID) values ('41','1','cheka');
Insert into HSC.INICIO_DIRECCION (IDDIRECCION,REGION_ID,USUARIO_ID) values ('1','1','salas_si');
Insert into HSC.INICIO_DIRECCION (IDDIRECCION,REGION_ID,USUARIO_ID) values ('21','1','invitado');
...
Insert into HSC.INICIO_USUARIO (USERNAME,CONTRASENNIA,NOMBRE,APELLIDO,EMAIL,TIPOUSUARIO_ID) values ('cheka','12345','Carloswfwfw','fabres','carlos@sexologo.com','2');
Insert into HSC.INICIO_USUARIO (USERNAME,CONTRASENNIA,NOMBRE,APELLIDO,EMAIL,TIPOUSUARIO_ID) values ('salas_si','2222','salas','gei','saasdasd@asdasd.com','2');
...
Insert into HSC.INICIO_USUARIO (USERNAME,CONTRASENNIA,NOMBRE,APELLIDO,EMAIL,TIPOUSUARIO_ID) values ('invitado','invitado','invitado','invitado','invitado@invitado.com','2');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HSC"."SYS_C0011505" ON "HSC"."INICIO_CATEGORIA" ("IDCATEGORIA") 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HSC"."SYS_C0011507" ON "HSC"."INICIO_COMUNA" ("IDCOMUNA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HSC"."SYS_C0011540" ON "HSC"."INICIO_DETALLE" ("IDDETALLE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HSC"."SYS_C0011534" ON "HSC"."INICIO_DIRECCION" ("IDDIRECCION") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HSC"."SYS_C0011509" ON "HSC"."INICIO_MARCA" ("IDMARCA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HSC"."SYS_C0011531" ON "HSC"."INICIO_MODELO" ("IDMODELO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "HSC"."INICIO_MOD_MARCA_ID_73855542" ON "HSC"."INICIO_MODELO" ("MARCA_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HSC"."SYS_C0011528" ON "HSC"."INICIO_PRODUCTO" ("IDPRODUCTO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HSC"."SYS_C0011522" ON "HSC"."INICIO_REGION" ("IDREGION") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HSC"."SYS_C0011511" ON "HSC"."INICIO_TIPOPROD" ("IDTIPOROD") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HSC"."SYS_C0011513" ON "HSC"."INICIO_TIPOUSUARIO" ("IDTIPOUSUARIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HSC"."SYS_C0011516" ON "HSC"."INICIO_USUARIO" ("USERNAME") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HSC"."SYS_C0011520" ON "HSC"."INICIO_VENTA" ("IDVENTA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HSC"."INICIO_MODELO" MODIFY ("IDMODELO" NOT NULL ENABLE);
  ALTER TABLE "HSC"."INICIO_MODELO" MODIFY ("MARCA_ID" NOT NULL ENABLE);
  ALTER TABLE "HSC"."INICIO_MODELO" ADD PRIMARY KEY ("IDMODELO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HSC"."INICIO_MODELO" ADD CONSTRAINT "INICIO_MO_MARCA_ID_73855542_F" FOREIGN KEY ("MARCA_ID")
